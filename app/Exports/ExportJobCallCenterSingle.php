...
class ExportJobCallCenterSingle implements FromCollection,WithHeadings, ShouldAutoSize, WithStyles
{
    ...
    public function headings():array{
        return ['Department','Full Name','Mobile Number','Whatsapp Number','Email','Job Type','Lob Level','Working Hours',
            'Working Shift','Expected Salary', 'Institution Name','Academic Qualification','Internet Medium','Device Access','Skills','Experiences',
            'Address', 'Division','District','Upazila/P.Station','Union/Pouroshova','Village/Word','Applied Date'
        ];
    }
    ...
    public function collection(){
        ...
        $field_set = ['department','full_name', 'mobile_number', 'whatsapp_number', 'email','job_type', 'job_level',
            'working_hours', 'working_shift', 'expected_salary', 'institution_name', 'acc_qualification', 'internet_connection', 'device_type', 'skills',
            'experiences','address', 'division_id', 'district_id', 'upazila_id', 'union_id', 'village_id','created_at'];
        ...
        if($this->id){
            ...
            $dataList = JobCallCenter::whereDate('created_at', '>=', '06/09/2022 00:00:00')->whereDate('created_at', '<=', '06/18/2022 23:59:59')->get($field_set);
        }
