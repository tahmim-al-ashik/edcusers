...
class TransDistributionLoopController extends Controller
{
    ...
    public function transDistributionLoopList(Request $request) : JsonResponse
    {
    ...
    public function transDistributionLoopDetails($id) : JsonResponse
    {
        $returned_data = ResponseWrapper::Start();

        // Fetch the transDistributionLoop record along with related data
        $transDistributionLoop = TransLoop::leftJoin('trans_pops', 'trans_loops.pop_id', '=', 'trans_pops.id')
    ...
    public function createTransDistributionLoop(Request $request) : JsonResponse
    {
            $returned_data = ResponseWrapper::Start();
    ...
    public function editTransDistributionLoop(Request $request, $id) : JsonResponse
    {
        $returned_data = ResponseWrapper::Start();
        $validated = $request->validate([
            'loop_id' => 'required',
    ...
    public function deleteTransDistributionLoop($id) : JsonResponse
    {
        $returned_data = ResponseWrapper::Start();
        $latLongDeleted = TransLatLong::where('trans_id', $id)->where('module_type','distribution_loop')->delete();
        $cableDeleted = TransCableDetail::where('trans_id', $id)->where('module_type','distribution_loop')->delete();
        $workerDeleted = TransWorkerInfo::where('trans_id', $id)->where('module_type','distribution_loop')->delete();

        // Fetch all images related to the pop
        $images = TransImage::where('trans_id', $id)->where('module_type','distribution_loop')->get();
        ...
        $imageDeleted = TransImage::where('trans_id', $id)->where('module_type','distribution_loop')->delete();
        $loopDeleted = TransLoop::where('id', $id)->where('loop_type','distribution_loop')->delete();
    ...
    public function summaryTransDistributionLoop() : JsonResponse {
        $returned_data = ResponseWrapper::Start();

        // summary
        $summary = TransLoop::where('loop_type','distribution_loop')->selectRaw(
    ...
    public function getTransDistributionLoopLatLong(Request $request) : JsonResponse {
        $returned_data = ResponseWrapper::Start();
