...
{
    // Joining Tj Box list ---
    public function transJoiningTjBoxList(Request $request) : JsonResponse
    {
    ...
    public function transJoiningTjBoxDetails($id) : JsonResponse
    {
        $returned_data = ResponseWrapper::Start();

        // Fetch the transBackboneTjBox record along with related data
        $transJoiningTjBox = TransTjBox::leftJoin('trans_pops', 'trans_tj_boxes.pop_id', '=', 'trans_pops.id')
                            ->with([
                                'joiningCableDetails',
                                'joiningCoreJoinInfo',
                                'joiningWorkerInfos',
    ...
    public function createTransJoiningTjBox(Request $request) : JsonResponse
    {
            $returned_data = ResponseWrapper::Start();
    ...
    // Edit Joining Tj Box ---
    public function editTransJoiningTjBox(Request $request, $id) : JsonResponse
    {
        $returned_data = ResponseWrapper::Start();
        $validated = $request->validate([
            'tj_box_id' => 'required',
    ...
    public function deleteTransJoiningTjBox($id) : JsonResponse
    {
        $returned_data = ResponseWrapper::Start();
        $latLongDeleted = TransLatLong::where('trans_id', $id)->where('module_type','joining_tj')->delete();
        $joinInfoDeleted = TransCoreJoinInfo::where('trans_id', $id)->where('module_type','joining_tj')->delete();
        $cableDeleted = TransCableDetail::where('trans_id', $id)->where('module_type','joining_tj')->delete();
        $workerDeleted = TransWorkerInfo::where('trans_id', $id)->where('module_type','joining_tj')->delete();

        // Fetch all images related to the pop
        $images = TransImage::where('trans_id', $id)->where('module_type','joining_tj')->get();
        ...
        $imageDeleted = TransImage::where('trans_id', $id)->where('module_type','joining_tj')->delete();
        $joiningTjDeleted = TransTjBox::where('id', $id)->where('tj_box_type','joining_tj')->delete();
    ...
    // Summary Tj Box ---
    public function summaryTransJoiningTjBox() : JsonResponse {
        $returned_data = ResponseWrapper::Start();

        // summary
        $summary = TransTjBox::where('tj_box_type','joining_tj')->selectRaw(
    ...
    public function getTransJoiningTjBoxLatLong(Request $request) : JsonResponse {
        $returned_data = ResponseWrapper::Start();
