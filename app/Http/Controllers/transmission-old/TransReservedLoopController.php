...
{
    // Reserved Loop list ---
    public function transReservedLoopList(Request $request) : JsonResponse
    {
    ...
    public function transReservedLoopDetails($id) : JsonResponse
    {
        $returned_data = ResponseWrapper::Start();

        // Fetch the transReservedLoop record along with related data
        $transReservedLoop = TransLoop::leftJoin('trans_pops', 'trans_loops.pop_id', '=', 'trans_pops.id')
    ...
    public function createTransReservedLoop(Request $request) : JsonResponse
    {
            $returned_data = ResponseWrapper::Start();
    ...
    // Edit Reserved Loop ---
    public function editTransReservedLoop(Request $request, $id) : JsonResponse
    {
        $returned_data = ResponseWrapper::Start();
        $validated = $request->validate([
            'loop_id' => 'required',
    ...
    public function deleteTransReservedLoop($id) : JsonResponse
    {
        $returned_data = ResponseWrapper::Start();
        $latLongDeleted = TransLatLong::where('trans_id', $id)->where('module_type','reserved_loop')->delete();
        $cableDeleted = TransCableDetail::where('trans_id', $id)->where('module_type','reserved_loop')->delete();
        $workerDeleted = TransWorkerInfo::where('trans_id', $id)->where('module_type','reserved_loop')->delete();

        // Fetch all images related to the pop
        $images = TransImage::where('trans_id', $id)->where('module_type','reserved_loop')->get();
        ...
        $imageDeleted = TransImage::where('trans_id', $id)->where('module_type','reserved_loop')->delete();
        $loopDeleted = TransLoop::where('id', $id)->where('loop_type','reserved_loop')->delete();
    ...
    public function summaryTransReservedLoop() : JsonResponse {
        $returned_data = ResponseWrapper::Start();

        // summary
        $summary = TransLoop::where('loop_type','reserved_loop')->selectRaw(
    ...
    public function getTransReservedLoopLatLong(Request $request) : JsonResponse {
        $returned_data = ResponseWrapper::Start();
