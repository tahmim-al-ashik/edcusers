...
class TransBackboneTjBoxController extends Controller
{
    ...
    public function transBackboneTjBoxList(Request $request) : JsonResponse
    {
    ...
    public function transBackboneTjBoxDetails($id) : JsonResponse
    {
        $returned_data = ResponseWrapper::Start();
    ...
    public function createTransBackboneTjBox(Request $request) : JsonResponse
    {
            $returned_data = ResponseWrapper::Start();
    ...
    public function editTransBackboneTjBox(Request $request, $id) : JsonResponse
    {
        $returned_data = ResponseWrapper::Start();
        $validated = $request->validate([
            'tj_box_id' => 'required',
    ...
    public function deleteTransBackboneTjBox($id) : JsonResponse
    {
        $returned_data = ResponseWrapper::Start();
        $latLongDeleted = TransLatLong::where('trans_id', $id)->where('module_type','backbone_tj')->delete();
        $joinInfoDeleted = TransCoreJoinInfo::where('trans_id', $id)->where('module_type','backbone_tj')->delete();
        $cableDeleted = TransCableDetail::where('trans_id', $id)->where('module_type','backbone_tj')->delete();
        $workerDeleted = TransWorkerInfo::where('trans_id', $id)->where('module_type','backbone_tj')->delete();

        // Fetch all images related to the pop
        $images = TransImage::where('trans_id', $id)->where('module_type','backbone_tj')->get();
        ...
        $imageDeleted = TransImage::where('trans_id', $id)->where('module_type','backbone_tj')->delete();
        $backboneTjDeleted = TransTjBox::where('id', $id)->where('tj_box_type','backbone_tj')->delete();
    ...
    // Summary Tj Box ---
    public function summaryTransBackboneTjBox() : JsonResponse {
        $returned_data = ResponseWrapper::Start();

        // summary
        $summary = TransTjBox::where('tj_box_type','backbone_tj')->selectRaw(
    ...
    public function getTransBackboneTjBoxLatLong(Request $request) : JsonResponse {
        $returned_data = ResponseWrapper::Start();
