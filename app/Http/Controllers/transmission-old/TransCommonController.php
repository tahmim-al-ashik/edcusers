...
class TransCommonController extends Controller
{
    ...
    public function getTransPopsByRadiation($id, $type, $latitude, $longitude, $radiation) : JsonResponse {
        $returned_data = ResponseWrapper::Start();
        $radiusInMeter = $radiation / 1000;
        $returned_data['results'] = TransLatLong::select(DB::raw("
    ...
    // Get Transmission Pop By radiation ---
    public function imageUploadTransmission(Request $request, $trans_id, $type) : JsonResponse {
        $returned_data = ResponseWrapper::Start();
    ...
    public function getAllTranSummary() : JsonResponse {
        $returned_data = ResponseWrapper::Start();
