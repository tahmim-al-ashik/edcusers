...
class TransSubBranchPopController extends Controller
{
    ...
    public function transSubBranchPopList(Request $request) : JsonResponse
    {
    ...
    public function transSubBranchPopDetails($id) : JsonResponse
    {
        $returned_data = ResponseWrapper::Start();
    ...
    public function createTransSubBranchPop(Request $request) : JsonResponse
    {
            $returned_data = ResponseWrapper::Start();
    ...
    public function editTransSubBranchPop(Request $request, $id) : JsonResponse
    {
        $returned_data = ResponseWrapper::Start();
        $validated = $request->validate([
            'pop_id' => 'required',
    ...
    public function deleteTransSubBranchPop($id) : JsonResponse
    {
        $returned_data = ResponseWrapper::Start();
        $latLongDeleted = TransLatLong::where('trans_id', $id)->where('module_type','sub_branch')->delete();
        $outputDeviceDeleted = TransPopOutputDeviceInfo::where('trans_id', $id)->where('module_type','sub_branch')->delete();
        $deviceDeleted = TransPopDeviceInfo::where('trans_id', $id)->where('module_type','sub_branch')->delete();
        $cableDeleted = TransCableDetail::where('trans_id', $id)->where('module_type','sub_branch')->delete();
        $workerDeleted = TransWorkerInfo::where('trans_id', $id)->where('module_type','sub_branch')->delete();
        ...
        $imageDeleted = TransImage::where('trans_id', $id)->where('module_type','sub_branch')->delete();
        $popDeleted = TransPop::where('id', $id)->where('pop_type','sub_branch')->delete();
    ...
    public function summaryTransSubBranchPop() : JsonResponse {
        $returned_data = ResponseWrapper::Start();

        // summary
        $summary = TransPop::where('pop_type','sub_branch')->selectRaw(
    ...
    // Lat Long list ---
    public function getTransSubBranchPopLatLong(Request $request) : JsonResponse {
        $returned_data = ResponseWrapper::Start();
