...
class TransInfoSarkarPopController extends Controller
{
    // Transmission Branch pop list ---
    public function transInfoSarkarPopList(Request $request) : JsonResponse
    {
        ...
        $query = $query->where('pop_type', 'info_sarkar_pop')
    ...
    // Transmission Branch pop list ---
    public function transInfoSarkarPops (Request $request) : JsonResponse
    {
        $returned_data = ResponseWrapper::Start();

        $query = TransPop::query();
        $query = $query->where('pop_type', 'info_sarkar_pop')->orderBy('trans_pops.id', 'desc')
            ->get([
                'trans_pops.id',
                'trans_pops.pop_code'
            ]);
    ...
    public function transInfoSarkarPopsTree () : JsonResponse
    {
        $returned_data = ResponseWrapper::Start();
    ...
    public function transInfoSarkarPopDetails($id) : JsonResponse
    {
        $returned_data = ResponseWrapper::Start();
    ...
    public function createTransInfoSarkarPop(Request $request) : JsonResponse
    {
            $returned_data = ResponseWrapper::Start();
            ...
            $address->module_type = 'info_sarkar_pop';
            ...
            foreach ($inCableData as $inCable) {
                ...
                $inCableModel->module_type = 'info_sarkar_pop';
            ...
            foreach ($outCableData as $outCable) {
                ...
                $outCableModel->module_type = 'info_sarkar_pop';
            ...
            $popDeviceInfo->module_type = 'info_sarkar_pop';
            ...
            foreach ($popOutputDeviceInfos as $popOutputDeviceInfo) {
                ...
                $popOutputModel->module_type = 'info_sarkar_pop';
            ...
            $workerInfo->module_type = 'info_sarkar_pop';
            ...
            $returned_data['status'] = 'success';
            $returned_data['message'] = 'Info Sarkar pop added successfully!';
            $returned_data['results'] = $popId;
            return ResponseWrapper::End($returned_data);
    }

    // Edit Transmission Branch Pop ---
    public function editTransInfoSarkarPop(Request $request, $id) : JsonResponse
    {
        $returned_data = ResponseWrapper::Start();
        $validated = $request->validate([
            'pop_id' => 'required',
    ...
    public function deleteTransInfoSarkarPop($id) : JsonResponse
    {
        $returned_data = ResponseWrapper::Start();
        $latLongDeleted = TransLatLong::where('trans_id', $id)->where('module_type','info_sarkar_pop')->delete();
        $outputDeviceDeleted = TransPopOutputDeviceInfo::where('trans_id', $id)->where('module_type','info_sarkar_pop')->delete();
        $deviceDeleted = TransPopDeviceInfo::where('trans_id', $id)->where('module_type','info_sarkar_pop')->delete();
        $cableDeleted = TransCableDetail::where('trans_id', $id)->where('module_type','info_sarkar_pop')->delete();
        $workerDeleted = TransWorkerInfo::where('trans_id', $id)->where('module_type','info_sarkar_pop')->delete();
        // Fetch all images related to the pop
        $images = TransImage::where('trans_id', $id)->where('module_type','info_sarkar_pop')->get();
        ...
        $imageDeleted = TransImage::where('trans_id', $id)->where('module_type','info_sarkar_pop')->delete();
        $popDeleted = TransPop::where('id', $id)->where('pop_type','info_sarkar_pop')->delete();
    ...
    public function summaryTransInfoSarkarPop() : JsonResponse {
        $returned_data = ResponseWrapper::Start();

        // summary
        $summary = TransPop::where('pop_type','info_sarkar_pop')->selectRaw(
    ...
    public function getTransInfoSarkarPopLatLong(Request $request) : JsonResponse {
        $returned_data = ResponseWrapper::Start();
        ...
        $query->where('module_type','info_sarkar_pop');
    ...
    public function bulkUploadTransInfoSarkarPop(Request $request) : JsonResponse
    {
        $returned_data = ResponseWrapper::Start();
    ...
    public function getTransLatLong(Request $request) : JsonResponse {
        $returned_data = ResponseWrapper::Start();
