...
class GraphSalesAgentUserController extends Controller
{
    /**
     * Sales Agent User Count Bar Chart
     */
    public function barchart() : JsonResponse {
        ...
        $totalByMonthAndStatus = SalesAgent::selectRaw('YEAR(created_at) AS year, MONTH(created_at) AS month, status, COUNT(*) AS total')
        ...
        $returned_data['results']['total'] = SalesAgent::count();
     ...
     */
    public function salesAgentLineChart($days, $type) : JsonResponse {
        $returned_data = ResponseWrapper::Start();

        // Calculate the date x days ago
        $startDate = now()->subDays($days)->startOfDay();

        $query = SalesAgent::selectRaw(
