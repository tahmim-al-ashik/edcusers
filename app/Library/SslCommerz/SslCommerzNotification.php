...
class SslCommerzNotification extends AbstractSslCommerz
{
    ...
    {
        $this->successUrl = rtrim($this->appConf['apiUrl'], '/') . $this->config['success_url'];
    }
    ...
    {
        $this->failedUrl = rtrim($this->appConf['apiUrl'], '/') . $this->config['failed_url'];
    }
    ...
    {
        Log::info($this->appConf['apiUrl']);
        Log::info($this->config['cancel_url']);
        $this->cancelUrl = rtrim($this->appConf['apiUrl'], '/') . $this->config['cancel_url'];
    }
    ...
    {
        $this->ipnUrl = rtrim($this->appConf['apiUrl'], '/') . $this->config['ipn_url'];
    }
