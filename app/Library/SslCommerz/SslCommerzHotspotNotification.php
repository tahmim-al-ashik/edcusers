...
class SslCommerzHotspotNotification extends AbstractSslCommerz
{
    protected $data = [];
    protected $config = [];
    protected $appConf = [];
    ...
    {
        $this->successUrl = rtrim($this->appConf['apiUrl'], '/') . $this->config['hotspot_success_url'];
    }
    ...
    {
        $this->failedUrl = rtrim($this->appConf['apiUrl'], '/') . $this->config['hotspot_failed_url'];
    }
    ...
    {
        $this->cancelUrl = rtrim($this->appConf['apiUrl'], '/') . $this->config['hotspot_cancel_url'];
    }
    ...
    {
        $this->ipnUrl = rtrim($this->appConf['apiUrl'], '/') . $this->config['hotspot_ipn_url'];
    }
