...
class ImportInternetUserToMainTable implements WithStartRow, ToCollection
{
    ...
    public function collection(Collection $rows)
    {
        ...
        foreach ($rows as $row){
            ...
            $isDuplicate = InternetUser::where('mobile_number', $mobile_number)->exists();
