...
use App\Models\TransmissionCustomersProblemCheck;
use Maatwebsite\Excel\Concerns\ToModel;
use Maatwebsite\Excel\Concerns\WithHeadingRow;

class TransmissionCustomersImportProblemCheck implements ToModel, WithHeadingRow
{
    /**
     * @param array $row
     *
    ...
    {
        return new TransmissionCustomersProblemCheck([
