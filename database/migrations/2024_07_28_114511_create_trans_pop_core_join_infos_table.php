...
class CreateTransPopCoreJoinInfosTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('trans_pop_core_join_infos', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('trans_pop_core_join_infos');
    }
}
